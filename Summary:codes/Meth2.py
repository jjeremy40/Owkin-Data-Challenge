...
"""CNN: LeNet-5
Train : sum of masks on the axis=2 then normalized for patient Event=1 and Public dataset (features 92x92, 128 patients)
...
result C-index : train public event=1 : 0.467 on public and 0.532 on private
"""
import numpy as np
import pandas as pd
...
train_base_public = np.empty((128, 92, 92))
